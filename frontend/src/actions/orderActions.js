...
export const deliverOrder= (orderId) => async(dispatch, getState) => {
  try{
    ...
    console.log("requset dispatched");
...
export const getOrderAnalysis = () => async(dispatch, getState) => {
  try{
    dispatch({ type: ORDER_ANALYSIS_REQUEST});
     ...
     const config = {
      ...
      const {data} = await axios.get(`/api/orders/analysis`, config);

      dispatch({ type: ORDER_ANALYSIS_SUCCESS, payload: data});
